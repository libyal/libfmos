...
LIBRARY_TESTS="adc error lzfse lzvn notify support";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./fmos_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libfmos");
