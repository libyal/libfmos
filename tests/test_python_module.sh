...
test_python_function()
{
	...
	local TEST_SCRIPT="${TEST_TOOL_DIRECTORY}/pyfmos_test_${TEST_FUNCTION}.py";
...
test_python_function_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "pyfmos");
