...
{
	static char *function = "libfmos_notify_set_stream";
...
int libfmos_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfmos_notify_stream_open";
...
int libfmos_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfmos_notify_stream_close";
